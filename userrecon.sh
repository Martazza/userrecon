...
check1=$(curl -s -i "https://$username.tumblr.com" -H "Accept-Language: en" -L --user-agent '"Mozilla/5.0 (X11; U; Linux i686; en-US; rv:0.9.3) Gecko/20010801"' -I | grep -o 'HTTP/2 404' ; echo $?)
...
check1=$(curl -s -i "https://www.instructables.com/member/$username" -H "Accept-Language: en" -L -I | grep -o 'HTTP/(1\.1|2) 404' ; echo $?)
...
check1=$(curl -s -i "https://angel.co/$username" -H "Accept-Language: en" -L -I | grep -o 'HTTP/2 404' ; echo $?)
...
check1=$(curl -s -i "https://foursquare.com/$username" -H "Accept-Language: en" -L -I | grep -o -E 'HTTP/(1\.1|1\.0|2) 404' ; echo $?)
...
check1=$(curl -s -i "https://creativemarket.com/$username" -H "Accept-Language: en" -L -I | grep -o 'HTTP/2 404' ; echo $?)
...
check1=$(curl -s -i "https://www.ifttt.com/p/$username" -H "Accept-Language: en" -L -I | grep -o 'HTTP/2 404\|404 Not Found' ; echo $?)
